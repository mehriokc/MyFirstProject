...
export default class LdsWireGet extends LightningElement {
    ...
    @wire(getPicklistValues, { recordTypeId: '0125e000000aKm5AAE', fieldApiName: COUNTRY_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValues, { recordTypeId: '0125e000000aKm5AAE', fieldApiName: STATE_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValues, { recordTypeId: '0125e000000aKm5AAE', fieldApiName: CITY_FIELD })
    ...
    //Below is for World recordType - replace the record type Id from your salesforce org
    @wire(getPicklistValuesByRecordType, { objectApiName: ACCOUNT_OBJECT, recordTypeId: '0125e000000aKm5AAE'})
    getCityPicklist({ data, error }) {
        if (data) {
